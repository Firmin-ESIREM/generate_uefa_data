class TimeManager:
	...
	def __init__(self, day=1, month=1, year=1970):
		...
		self.days = {"bissextile": [31,29,31,30,31,30,31,31,30,31,30,31], "not_bissextile": [31,28,31,30,31,30,31,31,30,31,30,31]}
		self.month = month
		self.year = year
		self.day = day
		self.is_bissextile()
	...
	def is_month_finished(self):
		...
		day = self.days[bissextile_string][self.month-1]
		if self.day > day:
			self.day = 1
			self.month += 1
